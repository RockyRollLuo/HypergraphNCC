...
public class GetUtils {
    ...
    public static int getMinSizeOfMap(HashMap<Integer, HashMap<Integer, Integer>> map) {
        int ret = Integer.MAX_VALUE;
        for (HashMap<Integer, Integer> subMap : map.values()) {
            ret = Math.min(subMap.size(), ret);
        }
        return ret;
    }
}
