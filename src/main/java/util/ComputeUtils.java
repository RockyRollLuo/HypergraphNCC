...
public class ComputeUtils {
    ...
    public static HashMap<Integer, Pair<Integer,Integer>> computeCoreEMapByCoreVMapPair(HashMap<Integer, ArrayList<Integer>> edgeMap, HashMap<Integer, Pair<Integer,Integer>> coreVMap) {
        HashMap<Integer, Pair<Integer,Integer>> coreEMap = new HashMap<>();
        ...
        for (Map.Entry<Integer, ArrayList<Integer>> entry : edgeMap.entrySet()) {
            ...
            for (Integer v : edge) {
                Pair<Integer,Integer> kcV=coreVMap.get(v);
                int kV = kcV.getKey();
                int cV = kcV.getValue();
...
//                k = Math.min(k, kcV.getKey());
//                c = Math.min(c, kcV.getValue());
            }
            coreEMap.put(eId,new Pair<>(k, c));
        }
        return coreEMap;
    }
